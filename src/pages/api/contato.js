...
export default async (req, res) => {
    ...
    var result = await client.sendEmail({
     ...
     /*  To: "contato@neosetcorretora.com.br", */
      ...
      ReplyTo: email,
      Subject: assunto,
      TextBody: `Nome: ${nome} - Telefone: ${telefone} -  Email: ${email} - Mensagem: ${mensagem}`,
      HtmlBody: `<p><strong>Nome: </strong>${nome}</p><br />
      <p><strong>Email: </strong>${email}</p><br />
      <p><strong>Assunto: </strong>${assunto}</p><br />
      <p>${mensagem}</p>
      <br /><br />
      <p>Enviado pelo formulário de contato no site: <a href="https://neoset.vercel.app/">https://www.neosetcorretora.com/</a></p>`,
  });
